...
import DealerConsistencyPage from "./components/DealerConsistencyPage";
...
export default function OfferLetterPage() {
  ...
  const rd = isDealer ? null : rolesData[role];
  ...
  const getPdfFileName = () => {
    if (isDealer) {
      return "Dealer-Consistency-Champion-Bonanza";
    }
