...
const productGalleryById = {
  ...
  "binola-khal": [
    "/images/products/binola-khal.jpeg",
  ],
  churi: [
    "/images/churi.jpeg",
  ],
  "feed-6000-plus": [
    "/images/products/feed-6000.png",
  ],
  "feed-8000-plus": [
    "/images/products/feed-8000.jpeg",
  ],
  "mava-mix": [
    "/images/mava-mix.PNG",
  ],
  "feed-10000-plus": [
    "/images/dairy-guruji10000+.PNG",
  ],
};
...
export default function ProductDetailClient({ product }) {
  ...
  const price = isPriceOnRequest ? null : product.price || 1099;
  const mrp = isPriceOnRequest ? null : product.mrp || 1299;
  ...
  const currentPrice = isPriceOnRequest
    ? null
    : selectedVariant?.price ?? price;
  const currentMrp = isPriceOnRequest ? null : selectedVariant?.mrp ?? mrp;
  const currentDiscount = isPriceOnRequest
    ? 0
    : selectedVariant
        ...
        <div className="flex flex-col lg:flex-row gap-6 relative">
              ...
              {isPriceOnRequest ? (
                <div className="rounded-lg border border-primary/10 bg-primary/5 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm text-gray-700">
                    Price depends on current market rate. Contact us for today's price.
                  </p>
                </div>
              ) : (
                <>
          ...
          <div className="w-full lg:w-[20%] font-sans">
            <div className="border border-gray-200 rounded-lg p-4 lg:sticky lg:top-24 bg-white">
              ...
              {isPriceOnRequest ? (
                <div>
                  <div className="text-[26px] font-bold leading-tight text-primary">
                    Market price
                  </div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  {isPriceOnRequest ? "Contact for Price" : "Add to Cart"}
                </button>
                <button
                  type="button"
                ...
                >
                  {isPriceOnRequest ? "Ask Today's Rate" : "Buy Now"}
                </button>
              </div>
              {toastMessage ? (
