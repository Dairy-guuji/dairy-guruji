...
const realProductImageMap = {
  ...
  "binola-khal": "/images/products/binola-khal.jpeg",
  churi: "/images/churi.jpeg",
  "feed-6000-plus": "/images/products/feed-6000.png",
  "feed-8000-plus": "/images/products/feed-8000.jpeg",
  "mava-mix": "/images/mava-mix.PNG",
  "feed-10000-plus": "/images/dairy-guruji10000+.PNG",
};
    ...
    () =>
      products.map((product) => {
        ...
        const currentPrice = isPriceOnRequest
          ? null
          : selectedVariant?.price ?? product.price ?? 1099;
        const currentMrp = isPriceOnRequest
          ? null
          : selectedVariant?.mrp ?? product.mrp ?? currentPrice;
        const discountPercent =
          !isPriceOnRequest && currentMrp > currentPrice
  ...
  const visibleProducts = useMemo(() => {
    ...
    if (sortBy === "price-low") {
      return [...searched].sort((a, b) => {
        if (a.isPriceOnRequest && b.isPriceOnRequest) return 0;
                    ...
                    <div className="mt-4">
                        ...
                        {product.isPriceOnRequest ? (
                          <div>
                            ...
                            <div className="mt-1 text-xs text-text-dark/55">
                              Price depends on current market rate
                            </div>
                          </div>
                        ) : (
                          <>
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-2">
                        ...
                        >
                          ...
                          {product.isPriceOnRequest ? "Contact" : "Add"}
                        </button>
                        ...
                        >
                          {product.isPriceOnRequest ? "Ask Price" : "Buy Now"}
                        </button>
                      </div>
