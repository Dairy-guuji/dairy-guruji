const baseProducts = [
...

  {
    id: "binola-khal",
    name: "Binola Khal",
    image: "/images/products/binola-khal.jpeg",
    description:
      "Kacchi ghani cottonseed oil cake made from high-quality binola. Dairy Guruji Binola Khal is 100% pure, without adulteration, and supports milk production, fat, SNF, digestion, and animal growth.",
    benefits: [
      "100% pure Binola Khal with no adulteration",
      "Made using high-quality cottonseed",
      "Supports increase in milk production",
      "Helps improve fat and SNF",
      "Keeps animals healthy and supports stronger digestion",
      "Supports physical growth and muscle development",
    ],
    benefitsHindiTitle: "Key benefits",
    benefitsHindi: [
      "Dairy Guruji Binola Khal 100% pure hai, ismein kisi bhi prakar ki milawat nahi ki gayi hai.",
      "Yeh khal banane mein uchch gunvatta wale binole ka upyog kiya gaya hai.",
      "Doodh ke utpadan mein vriddhi karta hai.",
      "Fat aur SNF ko badhata hai.",
      "Pashu ko swasth rakhta hai aur pachan tantra ko majboot karta hai.",
      "Pashuon ki sharirik vriddhi aur maanspeshiyon ke vikas mein sahayak hai.",
    ],
    composition: [
      { label: "Product type", value: "Kacchi ghani cottonseed oil cake" },
      { label: "Purity", value: "100% pure, no adulteration" },
      { label: "Raw material", value: "High-quality binola / cottonseed" },
    ],
    feedingInstructions: {
      items: [
        {
          label: "Cow / buffalo",
          value: "1-2 kg daily or as per ration plan",
        },
        {
          label: "High-yield animals",
          value: "Adjust according to milk yield and body condition",
        },
        {
          label: "Method of use",
          value: "Mix with cattle feed, fodder, or concentrate",
        },
      ],
      note: "Introduce gradually and provide clean drinking water with regular feeding.",
    },
    packaging: "50 किग्रा बैग में उपलब्ध",
    dosage: "Cow/Buffalo: 1-2 kg daily or as per ration plan",
    pack: "50 kg Bag",
    tag: "Cottonseed Oil Cake",
    problem:
      "Low milk production, poor milk let-down, weak digestion, low fat/SNF, and poor animal growth",
    specialNote:
      "This feed formulation is prepared in Australia especially keeping Indian animal breeds in mind. Its results are expected to be excellent.",
    farmerStory: {
      quote:
        "Dairy Guruji Binola Khal helped us improve ration quality, animal health, and milk performance with a pure cottonseed oil cake.",
      name: "धर्मेंद्र सिंह",
      location: "दूध उत्पादक, राजस्थान",
      result: "Better milk support, improved fat/SNF, and stronger digestion",
    },
  },

  {
    id: "churi",
    name: "Dairy Guruji Churi",
    image: "/images/churi.jpeg",
    description:
      "Balanced cattle feed enriched with protein, minerals, and vitamins to support milk production, fat, animal strength, immunity, and daily dairy nutrition.",
    benefits: [
      "Balanced animal feed for cows and buffaloes",
      "Rich in protein, minerals, and vitamins",
      "Supports milk production and milk fat",
      "Helps improve animal strength and body condition",
      "Supports immunity and overall health",
      "Suitable for regular dairy farm feeding",
    ],
    benefitsHindiTitle: "Key benefits",
    benefitsHindi: [
      "Santulit pashu aahar for regular dairy feeding.",
      "Bharpur protein, mineral aur vitamin yukt.",
      "Doodh utpadan aur fat support mein sahayak.",
      "Pashu ki taqat aur body condition ko support karta hai.",
      "Immunity aur overall health ko support karta hai.",
      "Cow aur buffalo ke daily feed ration ke liye upyogi.",
    ],
    composition: [
      { label: "Product type", value: "Balanced cattle feed / Churi" },
      { label: "Nutrition support", value: "Protein, minerals, and vitamins" },
      { label: "Pack size", value: "50 kg bag" },
    ],
    feedingInstructions: {
      items: [
        {
          label: "Cow / buffalo",
          value: "2-4 kg daily or as per milk yield and ration plan",
        },
        {
          label: "Feeding support",
          value: "Use with green fodder, dry fodder, and clean water",
        },
        {
          label: "Method of use",
          value: "Mix with the regular feed ration",
        },
      ],
      note: "Introduce gradually when changing feed and adjust quantity according to animal condition.",
    },
    packaging: "50 किग्रा बैग में उपलब्ध",
    dosage: "Cow/Buffalo: 2-4 kg daily or as per ration plan",
    pack: "50 kg Bag",
    tag: "Balanced Feed",
    problem:
      "Low milk production, low fat, weak body condition, poor immunity, and unbalanced daily ration",
    specialNote:
      "Use Dairy Guruji Churi as part of a balanced ration with proper fodder, minerals, and clean drinking water for best results.",
    farmerStory: {
      quote:
        "Dairy Guruji Churi helped make the daily ration more balanced with protein, mineral, and vitamin support.",
      name: "संदीप यादव",
      location: "दूध उत्पादक, हरियाणा",
      result: "Better ration balance, improved strength, and milk-fat support",
    },
  },
  ...
  },
  {
    id: "mava-mix",
    name: "Mava Mix",
    image: "/images/mava-mix.PNG",
    description:
      "Scientifically formulated high-density energy and milk solid (Mava & SNF) booster designed to improve milk thickness, fat percentage, and overall milk richness in dairy animals.",
    benefits: [
      "Enhances milk solids (Mava), fat percentage, and SNF",
      "Provides high-density energy for lactating animals",
      "Improves milk density, creaminess, and yield",
      "Supports faster recovery and body condition during peak lactation",
      "Improves digestion and feed conversion efficiency",
      "Helps animals maintain body weight and optimal health",
    ],
    benefitsHindiTitle: "Key benefits",
    benefitsHindi: [
      "दूध में मावा (SNF) और फैट की मात्रा में शानदार वृद्धि करता है।",
      "दुधारू पशुओं को उच्च ऊर्जा और पोषण प्रदान करता है।",
      "दूध उत्पादन और गाढ़ेपन को बढ़ाता है।",
      "पशु के स्वास्थ्य और शारीरिक क्षमता को बनाए रखता है।",
      "पाचन क्रिया और दाना पचाने की क्षमता को बेहतर बनाता है।",
    ],
    composition: [
      { label: "Mava & Fat Booster Active Base", value: "High Grade" },
      { label: "Rumen Bypass Energy", value: "15%" },
      { label: "Protein & Amino Profile", value: "20%" },
      { label: "Essential Calcium & Minerals", value: "Balanced" },
      { label: "Digestive Yeast & Probiotics", value: "Enriched" },
    ],
    feedingInstructions: {
      items: [
        {
          label: "Cow / buffalo (lactating)",
          value: "50-100 grams daily",
        },
        {
          label: "High-yield animals",
          value: "100-150 grams daily",
        },
        {
          label: "Method of use",
          value: "Mix with daily cattle feed or concentrate",
        },
      ],
      note: "Give daily with main feed ration for best results.",
    },
    packaging: "पॉउडर 1 किग्रा व 5 किग्रा में उपलब्ध",
    dosage: "50-100 g daily for lactating animals",
    pack: "1 kg & 5 kg",
    tag: "Mava & Fat Enhancer",
    problem: "Low milk fat, low SNF, thin milk, and poor cream/mava yield",
    specialNote: "यह फीड फॉर्मूलेशन ऑस्ट्रेलिया में विशेष रूप से भारत की पशु नस्लों को ध्यान में रखकर तैयार की गई है। इसके परिणाम बहुत ही शानदार देखने को मिलेंगे।",
    farmerStory: {
      quote: "दूध का फैट और मावा कम आ रहा था। Mava Mix का उपयोग करने के बाद दूध की क्वालिटी और फैट दोनों में बेहतरीन सुधार हुआ।",
      name: "रामेश्वर चौधरी",
      location: "दूध उत्पादक, राजस्थान",
      result: "दूध में फैट और मावा की मात्रा बढ़ी, बेहतर मुनाफा",
    },
  },
  {
    id: "feed-10000-plus",
    name: "Feed 10000+",
    image: "/images/dairy-guruji10000+.PNG",
    description:
      "Ultra-premium super-formula cattle feed engineered for high-yielding dairy cattle (15+ Liters/day), providing optimal protein, minerals, vitamins, and toxin binder support to maximize milk output and animal health.",
    benefits: [
      "Formulated for ultra high-yielding cows and buffaloes",
      "Maximizes milk yield, peak fat percentage, and SNF",
      "Advanced amino acid & toxin binder protection",
      "Boosts immunity and metabolic resilience",
      "Helps prevent post-calving energy drop and repeat breeding",
      "Enhances gut health and nutrient absorption",
    ],
    benefitsHindiTitle: "डेयरी गुरुजी 10000+ फीड क्यों अलग है, इसके फायदे :-",
    benefitsHindi: [
      "उच्च दुधारू पशुओं (15+ लीटर दूध) के लिए अति-उत्कृष्ट आहार।",
      "दूध के उत्पादन में अधिकतम वृद्धि करता है।",
      "फैट व S.N.F. को उच्चतम स्तर पर बढ़ाता है।",
      "पशु को पूर्ण रूप से स्वस्थ और ऊर्जावान रखता है।",
      "पाचन तंत्र व रोग प्रतिरोधक क्षमता को अत्यधिक मजबूत करता है।",
      "रिपीट ब्रीडिंग की समस्या को समाप्त करने में सहायक।",
      "खराब दाने / फंगल टॉक्सिन से पूर्ण सुरक्षा देता है।",
    ],
    nutritionalValue: [
      { label: "Value per Kg", value: "" },
      { label: "Crude Protein", value: "25%" },
      { label: "Fat", value: "6%" },
      { label: "NaHCO3", value: "10000 mg" },
      { label: "Calcium (Ca)", value: "8500 mg" },
      { label: "Phosphorus (P)", value: "5800 mg" },
      { label: "Magnesium (Mg)", value: "4000 mg" },
      { label: "Sulphur (S)", value: "3000 mg" },
      { label: "Sodium (Na)", value: "6000 mg" },
      { label: "Choline Chloride", value: "1000 mg" },
      { label: "L-Lysine HCl", value: "2500 mg" },
      { label: "DL-Methionine", value: "20 mg" },
      { label: "Toxin Binder", value: "5000 mg" },
      { label: "Yeast Powder", value: "5000 mg" },
      { label: "Moisture", value: "9.8%" },
    ],
    feedingInstructions: {
      items: [
        { label: "रोज का दूध: 15-18 लीटर", value: "रोज की फीड: 5-6 किलो" },
        { label: "रोज का दूध: 18-22 लीटर", value: "रोज की फीड: 6.5-7.5 किलो" },
        { label: "रोज का दूध: 22+ लीटर", value: "रोज की फीड: 8+ किलो" },
      ],
      note: "हर 2.5 लीटर दूध उत्पादन पर 1 किलो फीड दें।",
    },
    dosage: "1 kg feed per 2.5 litres of milk production",
    pack: "50 Kg Bag",
    tag: "Ultra Premium Feed",
    problem: "Low milk production in high yielders, energy deficit during peak lactation, low fat/SNF, and breeding delays",
    specialNote: "यह फीड फॉर्मूलेशन ऑस्ट्रेलिया में विशेष रूप से भारत की पशु नस्लों को ध्यान में रखकर तैयार की गई है। इसके परिणाम बहुत ही शानदार देखने को मिलेंगे।",
    farmerStory: {
      quote: "हाई यील्डिंग गायों के लिए डेयरी गुरुजी 10000+ का उपयोग किया। दूध उत्पादन 20 लीटर से बढ़कर 24 लीटर हो गया और फैट भी बहुत बढ़िया रहा।",
      name: "बलविंदर सिंह",
      location: "डेयरी फार्म, पंजाब",
      result: "दूध उत्पादन में 20% की बढ़ोतरी, पशुओं की सेहत बेहतरीन",
    },
  },
];
...
const detailByProduct = {
  ...
  "mava-mix": {
    suitableFor: [
      "Animals with low milk fat or low SNF percentage",
      "Milking cows and buffaloes needing higher milk density and richness",
      "High lactating animals needing extra energy and milk solids support",
    ],
    keyIngredients: [
      "Bypass fat and milk solid enhancers",
      "Essential trace minerals and digestive enzymes",
      "Energy-dense nutrition factors",
    ],
    usageTips: [
      "Mix thoroughly in daily feed or concentrate.",
      "Use continuously during lactation cycle for stable fat & SNF.",
      "Provide along with green fodder and clean drinking water.",
    ],
    expectedTimeline:
      "Visible improvement in milk fat and SNF is usually observed within 7-14 days.",
    bestTimeToUse: "Daily during lactation and milking period.",
  },
  "feed-10000-plus": {
    suitableFor: [
      "Ultra high milk-producing animals (15+ L/day)",
      "Farms targeting peak milk production with top fat & SNF",
      "Cows & buffaloes needing post-calving energy and health recovery",
    ],
    keyIngredients: [
      "High-grade bypass protein and bypass fat",
      "Enriched mineral-vitamin premix with Lysine & Methionine",
      "Advanced toxin binders and yeast culture",
    ],
    usageTips: [
      "Split daily feeding quantity across 2-3 feeding times.",
      "Introduce gradually over 4-7 days when shifting from regular feed.",
      "Ensure adequate dry fodder, green fodder, and clean water balance.",
    ],
    expectedTimeline:
      "Milk yield and quality response is generally seen within 7-14 days.",
  ...
  "binola-khal": {
    suitableFor: [
      "Cows and buffaloes with low milk production or poor milk let-down",
      "Animals needing better fat and SNF support",
      "Farms looking for pure cottonseed oil cake without adulteration",
      "Animals needing digestion, health, growth, and muscle-development support",
    ],
    keyIngredients: [
      "Kacchi ghani cottonseed oil cake",
      "100% pure Binola Khal",
      "High-quality cottonseed / binola",
    ],
    usageTips: [
      "Introduce gradually over a few days when adding to the ration.",
      "Mix with concentrate, cattle feed, or fodder for even intake.",
      "Use with mineral mixture, green fodder, dry fodder, and clean drinking water.",
    ],
    expectedTimeline:
      "Body condition and feeding response may improve with regular use over 2-3 weeks as part of a balanced ration.",
    bestTimeToUse: "Daily with the main feed ration.",
  },
  churi: {
    suitableFor: [
      "Cows and buffaloes needing balanced daily feed",
      "Animals needing protein, mineral, and vitamin support",
      "Farms targeting better milk production and fat support",
      "Animals with weak body condition or low immunity",
    ],
    keyIngredients: [
      "Balanced cattle feed base",
      "Protein-rich nutrition support",
      "Minerals and vitamins for daily dairy performance",
    ],
    usageTips: [
      "Introduce gradually when shifting from another feed.",
      "Split daily feeding across regular feeding times.",
      "Use with green fodder, dry fodder, mineral mixture, and clean drinking water.",
    ],
    expectedTimeline:
      "Milk, strength, and body-condition support may become visible within 10-21 days with consistent feeding.",
    bestTimeToUse: "Daily with the regular feed ration.",
  },
  "feed-6000-plus": {
    suitableFor: [
...
const productPricing = {
  ...
  "binola-khal": {
    ...
    mrp: null,
    priceOnRequest: true,
    variants: [{ label: "50 Kg", isDefault: true }]
  },
  churi: {
    price: null,
    mrp: null,
  ...
  "feed-6000-plus": {
    ...
    mrp: null,
    priceOnRequest: true,
    variants: [{ label: "45 Kg", isDefault: true }]
  },
  "feed-8000-plus": {
    price: null,
    mrp: null,
