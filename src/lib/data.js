...
export const categories = [
  ...
  {
    title: "Binola Khal",
    desc: "Kacchi ghani cottonseed oil cake made from high-quality binola. It is 100% pure, without adulteration, and supports milk, fat, SNF, digestion, and growth.",
    image: "/images/products/binola-khal.jpeg",
    points: [
      "100% pure, no adulteration",
      "Supports milk, fat and SNF",
      "Strengthens digestion and growth",
    ],
  },
  {
    title: "Dairy Guruji Churi",
    desc: "Balanced cattle feed enriched with protein, minerals, and vitamins to support milk production, fat, animal strength, and everyday dairy nutrition.",
    image: "/images/churi.jpeg",
    points: [
      "Protein, mineral and vitamin support",
      "Supports milk and fat",
      "Helps strength and immunity",
    ],
  },
  {
    title: "6000+ Feed",
  ...
  {
    title: "10000+ Feed",
    desc: "An ultra-premium super-formula cattle feed engineered for highest-yielding dairy cattle (15+ L/day), maximizing milk production, peak fat & SNF, immunity, and reproductive health.",
    image: "/images/dairy-guruji10000+.PNG",
    points: [
      "Designed for ultra high-yielders",
      "Maximum milk yield & peak fat %",
      "Advanced amino acid & toxin binder",
    ],
  },
  {
    title: "Mava Mix",
    desc: "A scientifically formulated high-density energy and milk solid (Mava & SNF) booster designed to improve milk thickness, fat percentage, and overall milk richness in dairy animals.",
    image: "/images/mava-mix.PNG",
    points: [
      "Enhances milk solids (Mava) & SNF",
      "Boosts milk fat % and creaminess",
      "Supports energy & body condition",
    ],
  },
